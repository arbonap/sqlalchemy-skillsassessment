...
class Model(db.Model):
    ...
    def __repr__(self):
        ...
        return "<Model model_id=%s year=%s brand_name=%s name=%s>" % (
...
class Brand(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    name = db.Column(db.String(64), db.ForeignKey('models.name'), nullable = True)
    ...
    def __repr__(self):
        ...
        return "<Brand brand_id=%s brand_name=%s founded=%s headquarters=%s discontinued=%s>" % (
